        ...
        <div class="col-md-11">
            <div class="card">
              <div class="card-header bg-primary">
                  <div class="row">
                        <div class="col-sm-7">
                            <a class="text-decoration-none" href="{{ route('mangaDetail', $episode->manga_id) }}">
                                  ...
                                  <tbody>
                                      <tr>
                                          <td width="20%">
                                            ...
                                            @else
                                                <a href="{{ route('readMangaEp',$back ) }}" class="btn btn-light float-right"  style="border-radius: 50px;">
                                                       <i class='fas fa-arrow-left'></i>
                                                </a>
                                            @endif
                                          </td>
                                          ...
                                          <td width="20%">
                                            ...
                                            @else
                                            <a href="{{ route('readMangaEp',$next ) }}" class="btn btn-light float-left" style="border-radius: 50px;">
                                                 <i class='fas fa-arrow-right'></i>
                                            </a>
                                            @endif
                          ...
                          <tbody>
                              <tr>
                                  <td width="20%">
                                    ...
                                    @else
                                        <a href="{{ route('readMangaEp',$back ) }}" class="btn btn-primary float-right"  style="border-radius: 50px;">
                                               <i class='fas fa-arrow-left'></i>
                                        </a>
                                    @endif
                                  </td>
                                  ...
                                  <td width="20%">
                                    @if($next == 0)
                                    <a  class="btn btn-primary float-left disabled" style="border-radius: 50px;">
                                         <i class='fas fa-arrow-right'></i>
                                    </a>
                                    @else
                                    <a href="{{ route('readMangaEp',$next ) }}" class="btn btn-primary float-left" style="border-radius: 50px;">
                                         <i class='fas fa-arrow-right'></i>
                                    </a>
                                    @endif
...
<script>
      $('#idSelect').bind("change keyup",function()
      {
          ...
          window.location = '/mangaDetail/episode/'+$(this).val();
      });
