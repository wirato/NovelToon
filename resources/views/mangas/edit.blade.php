    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" method="post" action="{{ route('mangas.update', $manga->id) }}">
                        <div class="form-group">
                            @csrf
                            {{ method_field('PUT') }}
                            <div class="col-md-12 mb-2">
                                <label>Manga Image</label><br>
                                <img id="image_preview_container" src="/uploads/mangaimage/{{ $manga->mangaimage }}" alt="preview image" style="height: 311px;">
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" required/ value="{{ $manga->title }}">
                            <label class="label">ผู้แต่ง: </label>
                            <input type="text" name="author" class="form-control" required/ value="{{ $manga->author }}">
                        </div>
                        <div class="form-group">
                            <label class="label">เรื่องย่อ: </label>
                            <!-- <textarea name="asa" rows="9" style="font-size:25px" class="form-control" required></textarea> -->
                            <textarea name="resume" rows="20" required>
                              {{ $manga->resume }}
                            </textarea>
