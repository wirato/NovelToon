...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card">
                <div class="card-header bg-primary"><h5 class="text-light">Create Novel</h5></div>
                <div class="card-body">
                    <form enctype="multipart/form-data" method="post" action="{{ route('novels.store') }}">
                        <div class="form-group">
                            @csrf
                            <div class="col-md-12 mb-2">
                                <label>Novel Image</label><br>
                                <img id="image_preview_container" src="/uploads/novelimage/novelimagedefault.jpg" alt="preview image" style="height: 311px;">
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="srsume" rows="20" required></textarea>
